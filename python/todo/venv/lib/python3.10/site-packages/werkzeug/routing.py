...
class Submount(RuleFactory):
    """Like `Subdomain` but prefixes the URL rule with a given string::
        ...
        url_map = Map([
            Rule('/', endpoint='index'),
            Submount('/menuhub', [
                Rule('/', endpoint='menuhub/index'),
                Rule('/entry/<entry_slug>', endpoint='menuhub/show')
            ])
        ])

    Now the rule ``'menuhub/show'`` matches ``/menuhub/entry/<entry_slug>``.
    """
...
class EndpointPrefix(RuleFactory):
    ...
    another string. This can be useful for sub applications::
        ...
        url_map = Map([
            Rule('/', endpoint='index'),
            EndpointPrefix('menuhub/', [Submount('/menuhub', [
                Rule('/', endpoint='index'),
